          ...
          {tab === 'security' && (
            <>
              ...
              <div className="card">
                ...
                <div className="pf-actions" style={{ marginTop: '1rem', display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
                  <Link to="/security/login-history" className="btn btn--outline">Login History</Link>
                  <Link to="/security/sessions" className="btn btn--outline">Active Sessions</Link>
                </div>
              </div>
            </>
          )}
