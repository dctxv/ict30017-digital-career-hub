...
3. language_grammar  {"score":0-100,"feedback":"","issues":[{"original":"","corrected":"","type":"GRAMMAR|CLARITY|SPELLING|TENSE|CAPITALISATION|VERB_STRENGTH"}]}
Score grammar, clarity, spelling, tense, capitalisation and verb strength. type MUST
be exactly one of those six tokens, uppercase, nothing else — the interface maps each
one to a display label itself, so any other value renders untranslated. Quote the
