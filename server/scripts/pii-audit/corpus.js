...
export const CORPUS = [
  ...
  /* ── 4 ── Education · Bangladesh (Bangla-script CV) ──────────────────── */
  {
    ...
    pii: [
      ...
      { cat: 'sensitive', value: 'ধর্ম ইসলাম' },
    ],
    keep: ['ঢাকা বিশ্ববিদ্যালয়', 'ইডেন মহিলা কলেজ', 'বি.এড', 'মোহাম্মদপুর সরকারি প্রাথমিক বিদ্যালয়', 'গণিত'],
  },
  ...
  /* ── 19 ── Agriculture · Bangladesh ───────────────────────────────────── */
  {
    ...
    keep: ['Department of Agricultural Extension', 'DAE', 'Bangladesh Agricultural University', 'Agricultural Training Institute, Ishurdi', 'IPM', 'BRRI dhan89', 'Religion Islam'],
  },
